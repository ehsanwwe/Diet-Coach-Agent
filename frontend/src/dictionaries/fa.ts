...
const fa: Dictionary = {
  ...
  onboarding: {
    ...
    wristPlaceholder: '۱۷',
    wristRange: 'دور مچ باید بین ۸ و ۳۵ سانتی‌متر باشد',
    ...
    ageRange: 'سن باید بین ۸ و ۱۲۰ سال باشد',
    heightRequired: 'قد الزامی است',
    heightRange: 'قد باید بین ۸۰ و ۲۳۰ سانتی‌متر باشد',
