    ...
    days = [
        {
            ...
            "summary": "شروع یک روز آرام با وعده‌های ساده و مقوی.",
            ...
            "meals": [
                {
                    ...
                    "description": "۲ کف دست نان سبوس‌دار + ۳۰ گرم پنیر کم‌چرب + ۲ عدد گردو + ۱ فنجان چای کمرنگ",
                    "portion_guidance": "۲ کف دست نان + ۳۰ گرم پنیر + ۲ عدد گردو",
                    "alternatives": ["۱ کاسه ماست با ۱ عدد میوه", "۲ کف دست نان با ۱۰ گرم کره"],
                    "preparation_notes": None,
                },
                {
                    "meal_type": "lunch",
                    "title": "ناهار: قورمه‌سبزی با برنج",
                    "description": "۷ قاشق غذاخوری برنج پخته + ۴ قاشق قورمه‌سبزی + ۱ کاسه سالاد شیرازی",
                    "portion_guidance": "۷ قاشق غذاخوری برنج + ۴ قاشق خورش قورمه‌سبزی + ۱ کاسه سالاد",
                    "alternatives": ["۱ کاسه عدسی با ۱ کف دست نان", "۲ تکه کوکو سبزی"],
                    "preparation_notes": None,
                },
                {
                    "meal_type": "dinner",
                    "title": "شام: عدسی با ماست",
                    "description": "۱ کاسه متوسط عدسی + ۳ قاشق ماست کم‌چرب + سبزی خوردن آزاد",
                    "portion_guidance": "۱ کاسه متوسط عدسی + ۳ قاشق ماست + سبزی خوردن",
                    "alternatives": ["۱ کاسه سوپ سبزیجات", "۱ عدد لبو + ۱ کف دست نان"],
                    "preparation_notes": None,
                },
                {
                    "meal_type": "snack",
                    "title": "میان‌وعده: میوه و آجیل",
                    "description": "۱ عدد میوه فصلی (سیب یا گلابی) + ۱۰ عدد بادام یا ۵ عدد گردو",
                    "portion_guidance": "۱ عدد میوه متوسط + ۲۰ تا ۳۰ گرم آجیل",
                    "alternatives": ["۱ کاسه کوچک ماست کم‌چرب", "۲ عدد هویج خام"],
                    "preparation_notes": None,
                },
            ],
        },
            ...
            "meals": [
                {
                    ...
                    "description": "۲ کف دست نان سبوس‌دار + ۳۰ گرم پنیر کم‌چرب + ۵ عدد گردو + ۱ فنجان چای کمرنگ",
                    "portion_guidance": "۲ کف دست نان + ۳۰ گرم پنیر + ۵ عدد گردو",
                    "alternatives": ["۱ کاسه ماست با ۱ قاشق عسل", "۲ کف دست نان با کره"],
                    "preparation_notes": None,
                },
                {
                    "meal_type": "lunch",
                    "title": "ناهار: جوجه‌کباب با برنج کنترل‌شده",
                    "description": "۱۸۰ گرم جوجه‌کباب گریل‌شده + ۸ قاشق غذاخوری برنج پخته + سبزی خوردن آزاد + ۱ کاسه سالاد شیرازی",
                    "portion_guidance": "۱۸۰ گرم جوجه + ۸ قاشق برنج + سبزی خوردن + سالاد شیرازی",
                    "alternatives": ["زرشک‌پلو با مرغ", "کباب تابه‌ای کم‌روغن با برنج"],
                    "preparation_notes": "جوجه را بدون پوست گریل کنید.",
                },
                {
                    "meal_type": "dinner",
                    "title": "شام: سوپ مرغ و سبزیجات",
                    "description": "۱ کاسه بزرگ سوپ مرغ با ۱ کف دست مرغ پخته + هویج + کرفس + ۱ کف دست نان",
                    "portion_guidance": "۱ کاسه بزرگ سوپ + ۱ کف دست نان",
                    "alternatives": ["۱۵۰ گرم ماهی بخارپز", "۱ کف دست مرغ آب‌پز + سبزیجات"],
                    "preparation_notes": None,
                },
                {
                    "meal_type": "snack",
                    "title": "میان‌وعده: ماست با خیار",
                    "description": "۱ کاسه کوچک ماست کم‌چرب + ۱ عدد خیار رنده‌شده + نعنا خشک",
                    "portion_guidance": "۱ کاسه کوچک ماست (۱۵۰ گرم) + ۱ عدد خیار",
                    "alternatives": ["۱ عدد میوه فصلی", "۲ عدد هویج با ماست"],
                    "preparation_notes": None,
                },
            ],
        },
            ...
            "meals": [
                {
                    ...
                    "description": "۱ کاسه ماست کم‌چرب + ۱ عدد میوه فصلی + ۱ قاشق عسل طبیعی + کمی دارچین",
                    "portion_guidance": "۱ کاسه ماست (۱۵۰ گرم) + ۱ عدد میوه + ۱ قاشق عسل",
                    "alternatives": ["۳۰ گرم پنیر + ۱ عدد گوجه + نان", "۲ کف دست نان با کره"],
                    "preparation_notes": None,
                },
                {
                    "meal_type": "lunch",
                    "title": "ناهار: قورمه‌سبزی با گوشت و برنج",
                    "description": "۱۵۰ گرم گوشت گوسفند یا گوساله در قورمه‌سبزی + ۸ قاشق غذاخوری برنج پخته + سبزی‌خوردن آزاد",
                    "portion_guidance": "۱۵۰ گرم گوشت + ۸ قاشق برنج + سبزی‌خوردن آزاد",
                    "alternatives": ["چلوکباب کوبیده با برنج", "خورشت فسنجان با مرغ و برنج"],
                    "preparation_notes": "گوشت را با حرارت ملایم بپزید تا لطیف شود.",
                },
                {
                    "meal_type": "dinner",
                    "title": "شام: عدسی با سالاد",
                    "description": "۱ کاسه متوسط عدسی + ۱ بشقاب سالاد ساده",
                    "portion_guidance": "۱ کاسه متوسط عدسی + ۱ بشقاب سالاد",
                    "alternatives": ["۱ کاسه سوپ جو", "۱ کاسه لوبیا پخته"],
                    "preparation_notes": None,
                },
                {
                    "meal_type": "snack",
                    "title": "میان‌وعده: هویج و کرفس",
                    "description": "۳ عدد هویج متوسط + ۲ ساقه کرفس + ۲ قاشق ماست کم‌چرب",
                    "portion_guidance": "۳ عدد هویج + ۲ ساقه کرفس + ۲ قاشق ماست",
                    "alternatives": ["۱۰ عدد بادام", "۱ عدد سیب"],
                    "preparation_notes": None,
                },
            ],
        },
            ...
            "meals": [
                {
                    ...
                    "description": "۱ کاسه ماست چکیده + ۵ عدد گردو + ۱ قاشق عسل طبیعی",
                    "portion_guidance": "۱ کاسه ماست چکیده (۱۵۰ گرم) + ۵ عدد گردو + ۱ قاشق عسل",
                    "alternatives": ["۳۰ گرم پنیر + سبزیجات + نان", "۲ کف دست نان با کره"],
                    "preparation_notes": None,
                },
                {
                    "meal_type": "lunch",
                    "title": "ناهار: مرغ با سبزیجات و برنج",
                    "description": "۱ کف دست سینه مرغ بخارپز (حدود ۱۲۰ گرم) + ۷ قاشق غذاخوری برنج پخته + ۱ بشقاب سبزیجات فصلی",
                    "portion_guidance": "۱ کف دست مرغ (۱۲۰ گرم) + ۷ قاشق برنج + ۱ بشقاب سبزیجات",
                    "alternatives": ["۱۵۰ گرم ماهی گریل", "۸ قاشق لبوپلو"],
                    "preparation_notes": "مرغ را بدون پوست بپزید.",
                },
                {
                    "meal_type": "dinner",
                    "title": "شام: لوبیا پخته با نان",
                    "description": "۱ کاسه لوبیا چیتی پخته + ۲ عدد گوجه + ۱ کف دست نان سبوس‌دار",
                    "portion_guidance": "۱ کاسه لوبیا + ۱ کف دست نان سبوس‌دار",
                    "alternatives": ["۱ کاسه سوپ عدس", "۲ تکه کوکو سیب‌زمینی"],
                    "preparation_notes": None,
                },
                {
                    "meal_type": "snack",
                    "title": "میان‌وعده: دوغ و میوه",
                    "description": "۱ لیوان دوغ کم‌نمک (۲۵۰ میلی‌لیتر) + ۱ عدد میوه فصلی",
                    "portion_guidance": "۲۵۰ میلی‌لیتر دوغ + ۱ عدد میوه متوسط",
                    "alternatives": ["۱ کاسه ماست", "۲۰ گرم آجیل"],
                    "preparation_notes": None,
                },
            ],
        },
        {
            ...
            "meals": [
                {
                    "meal_type": "breakfast",
                    "title": "صبحانه: ماست با عسل و گردو",
                    "description": "۱ کاسه ماست کم‌چرب + ۱ قاشق عسل طبیعی + ۵ عدد گردو + ۱ عدد میوه فصلی",
                    "portion_guidance": "۱ کاسه ماست (۱۵۰ گرم) + ۱ قاشق عسل + ۵ عدد گردو",
                    "alternatives": ["۳۰ گرم پنیر + ۲ کف دست نان", "۲ کف دست نان با کره"],
                    "preparation_notes": None,
                },
                {
                    "meal_type": "lunch",
                    "title": "ناهار: ماهی بخارپز با سبزیجات",
                    "description": "۱۵۰ گرم فیله ماهی بخارپز + آب‌لیمو + ۱ بشقاب سبزیجات فصلی",
                    "portion_guidance": "۱۵۰ گرم ماهی + ۱ بشقاب سبزیجات",
                    "alternatives": ["۱ کف دست مرغ گریل (۱۲۰ گرم)", "۱ کف دست کباب کوبیده سبک"],
                    "preparation_notes": "با حداقل نمک بپزید.",
                },
                {
                    "meal_type": "dinner",
                    "title": "شام: آش جو",
                    "description": "۱ کاسه متوسط آش جو با سبزیجات تازه + ۱ قاشق آب‌لیمو",
                    "portion_guidance": "۱ کاسه متوسط آش جو (۳۰۰ گرم)",
                    "alternatives": ["۱ کاسه سوپ عدس", "۱ کاسه عدسی"],
                    "preparation_notes": None,
                },
                {
                    "meal_type": "snack",
                    "title": "میان‌وعده: میوه فصلی",
                    "description": "۱ عدد میوه فصلی تازه (سیب، گلابی یا هلو، اندازه متوسط)",
                    "portion_guidance": "۱ عدد میوه متوسط (حدود ۱۵۰ گرم)",
                    "alternatives": ["۱۰ عدد بادام", "۱ کاسه ماست"],
                    "preparation_notes": None,
                },
            ],
        },
        {
            ...
            "meals": [
                {
                    "meal_type": "breakfast",
                    "title": "صبحانه: چای با نان و پنیر",
                    "description": "۱ فنجان چای کمرنگ + ۲ کف دست نان سبوس‌دار + ۳۰ گرم پنیر کم‌نمک یا ۱۰ گرم کره",
                    "portion_guidance": "۱ فنجان چای + ۲ کف دست نان + ۳۰ گرم پنیر",
                    "alternatives": ["۱ کاسه ماست با ۱ قاشق عسل", "۱ عدد میوه با ۲۰ گرم آجیل"],
                    "preparation_notes": None,
                },
                {
                    "meal_type": "lunch",
                    "title": "ناهار: سبزی‌پلو با ماهی",
                    "description": "۸ قاشق غذاخوری سبزی‌پلو (برنج با شوید و جعفری) + ۱۰۰ گرم ماهی سفید بخارپز",
                    "portion_guidance": "۸ قاشق غذاخوری سبزی‌پلو + ۱۰۰ گرم ماهی",
                    "alternatives": ["۲ تکه کوکو سبزی + سالاد", "۱ کف دست مرغ + سبزیجات"],
                    "preparation_notes": None,
                },
                {
                    "meal_type": "dinner",
                    "title": "شام: سوپ سبزیجات",
                    "description": "۱ کاسه بزرگ سوپ سبزیجات بدون خامه (هویج، کرفس، پیاز، سیب‌زمینی)",
                    "portion_guidance": "۱ کاسه بزرگ سوپ (۳۵۰ گرم)",
                    "alternatives": ["۱ کاسه عدسی", "۱ کاسه ماست با خیار + ۱ کف دست نان"],
                    "preparation_notes": None,
                },
                {
                    "meal_type": "snack",
                    "title": "میان‌وعده: کشمش و بادام",
                    "description": "۱۵ گرم کشمش + ۱۰ گرم بادام بدون نمک (مجموعاً ۲۵ گرم)",
                ...
                },
                {
                    ...
                    "title": "Cheating Date",
                    "description": "یک وعده انعطاف‌پذیر کنترل‌شده — مثلاً جوجه‌کباب یا چلوکباب در رستوران، یا غذای مورد علاقه با حجم کنترل‌شده. این یک وعده برنامه‌ریزی‌شده است، نه پرخوری. وعده بعدی به برنامه عادی برمی‌گردد.",
                    "portion_guidance": "حجم کنترل‌شده: نه بیشتر از ۱ تا ۲ واحد غذای دلخواه. زمان پیشنهادی: ۲۰ تا ۲۲.",
                    "alternatives": ["چلوکباب کوبیده رستوران", "جوجه‌کباب با برنج", "پیتزا ۲ برش"],
                    "preparation_notes": None,
            ...
            "meals": [
                {
                    ...
                    "description": "۱ کاسه ماست کم‌چرب + ۱ عدد میوه فصلی + ۵ عدد گردو",
                    "portion_guidance": "۱ کاسه ماست (۱۵۰ گرم) + ۱ عدد میوه + ۵ عدد گردو",
                    "alternatives": ["۳۰ گرم پنیر + ۵ عدد گردو + نان", "۲ کف دست نان با کره"],
                    "preparation_notes": None,
                },
                {
                    "meal_type": "lunch",
                    "title": "ناهار: چلوکباب کوبیده",
                    "description": "۲ سیخ کباب کوبیده گوشت مخلوط (۲۰۰ گرم) + ۸ قاشق غذاخوری برنج پخته + گوجه کبابی + سبزی‌خوردن",
                    "portion_guidance": "۲ سیخ کباب (۲۰۰ گرم) + ۸ قاشق برنج + گوجه کبابی",
                    "alternatives": ["چلوکباب برگ", "جوجه‌کباب با برنج"],
                    "preparation_notes": "گوشت مخلوط (گوساله و گوسفند) را کبابی کنید.",
                },
                {
                    "meal_type": "dinner",
                    "title": "شام: کشک بادمجان",
                    "description": "۱ بشقاب کوچک کشک بادمجان + ۱ کف دست نان سبوس‌دار + ۱ بشقاب سالاد",
                    "portion_guidance": "۱ بشقاب کوچک کشک بادمجان + ۱ کف دست نان",
                    "alternatives": ["۱ کاسه ماست با خیار + نان", "۱ کاسه سوپ"],
                    "preparation_notes": None,
                },
                {
                    "meal_type": "snack",
                    "title": "میان‌وعده: چای با آجیل",
                    "description": "۱ فنجان چای کمرنگ + ۲۰ گرم آجیل (۱۰ عدد بادام یا ۵ عدد گردو)",
                    "portion_guidance": "۱ فنجان چای + ۲۰ گرم آجیل",
                    "alternatives": ["۱ عدد میوه فصلی", "۱ لیوان دوغ"],
                    "preparation_notes": None,
                },
            ],
        },
